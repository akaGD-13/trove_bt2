...
for z in range(4):
    ...
    for i in range(df21.index[-1]+1):
            ...
            value = value * (df21.loc[i,'pct_chg']/100 + 1)
            df21.loc[i,'value'] = value
    ...
    plt.plot(df21.index[99:], df21.loc[99:df21.index[-1]+1,'value'], label = 'HS300')
    plt.legend()
    plt.title(standard, fontsize=12)
    plt.savefig(standard+'2_09-23.png')
    plt.show()
